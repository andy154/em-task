...
### Предложите конкретные исправления для устранения этих противоречий - напишите свою версию этого фрагмента ТЗ, которая должна быть логически завершенной и непротиворечивой.
  ...
  9. Система должна поддерживать отображение рекламного блока в корзине.
  10. Реклама товаров в корзине должна быть с понедельника по пятницу в промежутки времени 08:00–11:00 и 18:00–21:00 по локальному времени пользователя
  11. Цена товара в корзине обновляется вместе с ценой товара в каталоге.
